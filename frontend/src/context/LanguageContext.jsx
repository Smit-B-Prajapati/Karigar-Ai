...
export const TRANSLATIONS = {
  EN: {
    ...
    addProduct: {
      ...
      materialCostLabel: 'Material Cost (₹) (Optional)',
      costHelp: 'Optional — AI Studio will suggest optimal selling price and margin automatically.',
      voiceHeroDescCompact: 'Speak naturally in Hindi or English — AI automatically fills your form!',
      step1Title: 'Step 1: Product Basics Form',
      step1Subtitle: 'Fill or speak craft details below. Can be modified anytime.',
  ...
  HI: {
    ...
    addProduct: {
      ...
      materialCostLabel: 'सामग्री लागत (₹) (वैकल्पिक)',
      costHelp: 'वैकल्पिक — एआई स्टूडियो स्वचालित रूप से अनुशंसित मूल्य और लाभ मार्जिन सुझाएगा।',
      voiceHeroDescCompact: 'हिंदी या अंग्रेजी में बोलें — एआई स्वचालित रूप से फॉर्म भर देगा!',
      step1Title: 'चरण 1: उत्पाद का बुनियादी विवरण',
      step1Subtitle: 'नीचे शिल्प विवरण भरें या बोलें। इसे कभी भी बदला जा सकता है।',
